...
var CloudinaryImage = (function (_React$Component) {
  ...
  _createClass(CloudinaryImage, [{
    ...
    value: function render() {
      ...
      var urlParams = [this.props.width && 'w_' + this.props.width, this.props.height && 'h_' + this.props.height, this.props.crop && 'c_' + this.props.crop];

      // Make comma-separated string of existing props ('w_123,h_456')
      var urlParamsStr = urlParams.filter(function (param) {
        return param;
      }).join(',');
    ...
    key: 'propTypes',
    value: {
      urlBase: _react2['default'].PropTypes.string.isRequired,
